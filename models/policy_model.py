...
class PolicyModel(with_metaclass(ABCMeta, Model)):
    ...
    def update_pi(self, advantage, state):
        """Informs the model of the advantage values for a given batch of
        states. Note that `advantage` is capable of being an n-step advantage.

        Args:
            advantage:  A batch of the advantage values as a numpy array. The
                model will use this to improve.
