...
from abc import ABCMeta, abstractmethod, ab
...
class Environment(with_metaclass(ABCMeta, object)):
    ...
    def __init__(self, *, max_trajectory_length=None, seed=None):
        ...
        Args:
            max_trajectory_length:  An int for the maximum length of the
                ...
                unbounded length.
            seed:  An integer used to seed the environment. If `None`, the seed
                will be random.
        """
        self._seed = seed
        self._env = None
    ...
    def step(self, action):
        """Steps the environment based on a provided action. Also updates the
        stored trajectory.
