...
def make_env(env_idx):
    ...
    env = make(game=dicts[env_idx]['game'], state=dicts[env_idx]['state'], record='./mov/')#, bk2dir="./records")#record='/tmp')
...
def make_train_MountainCarContinuous():
